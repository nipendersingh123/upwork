...
@section('site_title',__('Edit Job'))
@section('style')
            ...
            <div class="container">
                <div class="account-setup-wrapper">
                    ...
                    <div class="single-setup-account-inner custom-form profile-border-top">
                        <x-validation.error/>
                        <form action="{{ route('client.job.edit',$job_details->id) }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            @include('frontend.user.client.job.edit.job-details')
                            @include('frontend.user.client.job.edit.job-budget')
                            @include('frontend.user.client.job.edit.job-footer')
                        </form>
                    </div>
                </div>
            </div>
...
@section('script')
    @include('frontend.user.client.job.edit.edit-job-js')

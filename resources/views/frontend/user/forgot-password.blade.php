                ...
                <div class="login-wrapper-contents margin-inline login-shadow login-padding">
                    ...
                    <form class="login-wrapper-form custom-form" method="post" action="{{ route('user.forgot.password') }}">
                        ...
                        <div class="single-input mt-4">
                            <label class="label-title mb-3"> {{ __('Email or username') }} </label>
                            <input class="form--control" name="email" type="text" placeholder="{{ __('Enter email or username') }}" autocomplete="username">
                        </div>

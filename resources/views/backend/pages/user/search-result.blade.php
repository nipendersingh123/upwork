            ...
            <tr>
                ...
                <td>
                    ...
                    <ul class="dropdown-menu status_dropdown__list">
                        ...
                        @endcan
                        @if($user->user_type == 2)
                            @can('user-individual-commission-settings')
                            <li class="status_dropdown__item">
                                <a class="btn dropdown-item status_dropdown__list__link individual_commission_settings_modal"
                                   ...
                                   data-user_id_for_individual_settings="{{ $user->id }}"
                                   data-admin_commission_type="{{ $user->admin_commission?->admin_commission_type ?? '' }}"
                                   data-admin_commission_charge="{{ $user->admin_commission?->admin_commission_charge ?? ''  }}"
                                >
                                    {{ __('Individual Commission Settings') }}
                                </a>
                            </li>
                            @endcan
                        @endif
                        ...
                        @if(moduleExists('SecurityManage'))
                            ...
                            <x-status.table.status-change :title="__($is_project_freeze)" :url="route('admin.freelancer.project.freeze',$user->id)"/>

...
class FreelancerSubscriptionController extends Controller
{
    public function all_subscription()
    {
        ...
        return view('subscription::frontend.freelancer.subscription.subscription',compact('all_subscriptions','total_limit'));
    }
    ...
    function pagination(Request $request)
    {
        if($request->ajax()){
            ...
            return view('subscription::frontend.freelancer.subscription.search-result', compact('all_subscriptions'))->render();
        }
    }
    ...
    public function search_history(Request $request)
    {
        ...
        return $all_subscriptions->total() >= 1 ? view('subscription::frontend.freelancer.subscription.search-result', compact('all_subscriptions'))->render() : response()->json(['status'=>__('nothing')]);
    }
}
